...
In Method 2 we propose to partition the data into two subsets, and evaluate the estimates based on the ``training'' subset using the likelihood based on the ``evaluation'' subset.
